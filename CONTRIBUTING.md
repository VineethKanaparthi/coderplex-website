...
**Note:**
    So our team's official policy (for now) is we only use Yarn as our official Node package manager, and so we request you to     use Yarn instead of npm and commit yarn.lock file.
